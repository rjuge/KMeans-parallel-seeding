...
@author: romain
"""
'kmeans sklearn, dataset sklearn, seeding_parallel dans inti'
'error avec intertie'
'mettre la vitesse'
'verbose = true pour linitialisation de klearn'
...
def bench_k_means(estimator, name, data):
    t0 = time()
    estimator.fit(data)
    print(name, (time() - t0), estimator.inertia_)
...
print('_____init: KMEANS++implemented______')
t0 = time()
seeding = seeding_parallel(data,5, 20, n_digits, 'euclidean',random_state=None, weights=None)
print((time() - t0))
